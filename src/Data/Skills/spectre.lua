...
skills["BanditExplosiveArrowAtAnimationSpeed"] = {
	...
	description = "잠시 동안 퓨즈 역할을 하는 화살을 발사합니다. 같은 적에게 폭발 화살을 추가로 명중시킬 경우 퓨즈 충전이 증가하며 지속시간이 연장됩니다. 대상이 죽거나 퓨즈 지속시간이 만료되면 화살이 폭발하여 주변의 적들에게 범위 화염 피해를 줍니다. 반경은 적 사망 당시 충전된 퓨즈 수 따라 적용됩니다.",
...
skills["DemonModularBladeVortexSpectre"] = {
	...
	description = "일정 시간 동안 천상의 칼날이 주변을 회전하며 칼날에 스치는 적들에게 반복적인 피해를 줍니다.",
...
skills["GoatmanMoltenShell"] = {
	...
	incrementalEffectiveness = 0.037999998778105,
	description = "불타는 보호막을 소환하여 잠시 동안 방어도를 증가시킵니다. 효과가 지속되는 동안 막기 또는 방어 행동으로 막아낸 물리 피해가 한계치에 도달할 경우 보호막이 폭발하여 주변 적들에게 화염 피해를 줍니다.",
...
skills["GuardianArc"] = {
	...
	description = "시전자로부터 지정된 적에게 번개 줄기가 뻗어 나가 주변의 적들에게 옮겨가며, 연쇄될때마다 그 피해가 조금씩 감소합니다. 번개 줄기의 연쇄효과는 첫 줄기에만 적용되며, 파생된 줄기에는 적용되지 않습니다.",
...
skills["NecromancerRaiseZombie"] = {
	...
	color = 4,
	baseEffectiveness = 0,
	description = "시신에서 좀비 하나를 소환합니다. 좀비는 시전자를 따라다니며 적에게 근접 공격과 피할 수 없는 범위 공격을 합니다.",
...
skills["TarMortarTaster"] = {
	...
	description = "몬스터 박격포 스킬과 흡사하지만, 충격 시 지면 효과를 남깁니다.",
	skillTypes = { [SkillType.Projectile] = true, [SkillType.ProjectilesFromUser] = true, [SkillType.Spell] = true, [SkillType.Damage] = true, [SkillType.Area] = true, [SkillType.Trappable] = true, [SkillType.Totemable] = true, [SkillType.Mineable] = true, [SkillType.Multicastable] = true, [SkillType.Triggerable] = true, [SkillType.AreaSpell] = true, },
	statDescriptionScope = "skill_stat_descriptions",
	castTime = 1,
	baseFlags = {
...
skills["AtlasCrusaderJudgeBallLightning"] = {
	...
	incrementalEffectiveness = 0.045000001788139,
	description = "움직이는 투사체를 시전해 적들에게 지속 번개 피해를 줍니다.",
...
skills["LegionTemplarJudgeStormCall"] = {
	...
	description = "원하는 지점을 대상으로 설정합니다. 잠시 후 번개가 대상 지역을 강타하여 주변에 피해를 줍니다. 이와 동시에 시전자가 설정한 다른 모든 대상 지역에도 번개가 떨어집니다.",
